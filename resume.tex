...
\begin{itemize}[leftmargin=*]
  ...
  \item \textbf{Security:} Security Consultant experience (LMG Security), bringing a security-first lens to system design, data handling, and infrastructure decisions
\end{itemize}
