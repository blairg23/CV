...
\newcommand{\docversion}{v2026.03.27} % <-- update when you want
...
\begin{itemize}
  ...
  \item \textbf{AI/Automation Integrations (2022--Present):} Built internal tools/bots using OpenAI API and n8n with Slack integrations to automate reporting, summarization, approvals, and human-in-the-loop workflows.
