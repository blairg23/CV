...
\section*{Summary}
Full-stack software engineer and technical product strategist specializing in automation, delivery systems, and cloud infrastructure on AWS. In the past five years: raised deploy cadence, standardized CI/CD and IaC, and improved reliability with clear observability. I focus on systems that reduce toil, surface signal, and ship value quickly. Recently, I have been leveraging AI resources and tools such as ChatGPT, MCP, and Linear to maintain quality while reducing research and development costs.
...
\begin{itemize}
  ...
  \item AI and automation integrations: LLM APIs with Slack bots for approvals, summaries, and internal tools.
\end{itemize}
...
\begin{itemize}
  ...
  \item On-call with fast rollback; moved cadence from monthly to daily (or multiple times daily) and reduced release overhead about 30 percent.
\end{itemize}
