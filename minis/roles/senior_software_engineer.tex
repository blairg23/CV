...
\begin{itemize}
  ...
  \item AI and automation integrations (2022 - 2025): LLM APIs with Slack bots for approvals and summaries with people in the loop when needed.
\end{itemize}
...
\begin{itemize}
  ...
  \item Result: monthly to daily (or multiple times daily) deploys and about 30 percent less release overhead.
\end{itemize}
